...
#     model.add(tf.keras.layers.Dense(128, activation='relu', input_shape=(INPUTS_r,),kernel_initializer=tf.keras.initializers.GlorotUniform()))
#     model.add(tf.keras.layers.Dropout(0.2))
#     model.add(tf.keras.layers.BatchNormalization())
#     model.add(tf.keras.layers.Dense(32, activation='relu',kernel_initializer=tf.keras.initializers.GlorotUniform()))
#     model.add(tf.keras.layers.Dropout(0.2))
#     model.add(tf.keras.layers.BatchNormalization())
#     model.add(tf.keras.layers.Dense(32, activation='relu',kernel_initializer=tf.keras.initializers.GlorotUniform()))
#     model.add(tf.keras.layers.Dropout(0.2))
